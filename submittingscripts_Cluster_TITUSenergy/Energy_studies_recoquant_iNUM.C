...
#include "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/include/WCLTreeReader.hh"
#include "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/include/HighEReco.hh"
#include "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/include/LowEReco.hh"
...
////////////////////////
void Energy_studies_recoquant_iNUM(//TString filename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/scripts/nicolas/muCov/mask40/output_photon_mask/nu_numu_iNUM_out_12in_mask.root",
				   TString filename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/scripts/outputs_photonmask_fortraining/nu_numu_iNUM_out_12in_new_fortraining.root",
				   //TString filename = "/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/nicolas/muCov/mask40/output_photon_mask/nu_numu_1000_out_12in_mask.root",
				   //TString genfilename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChSandBox/outputs/flav_numu/nu_numu_iNUM/generatorcardfile.root",
				   TString genfilename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChSandBox/outputs/flav_numu_fortrain/nu_numu_iNUM/generatorcardfile.root",
				   //TString genfilename = "/Disk/ds-sopa-group/PPE/titus/ts-WChSandBox/outputs/flav_numu/nu_numu_1000/generatorcardfile.root",
			      //TString outfilename = "/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/nu_numu_1000_12in_energy_studies_CCQE.root",//"testout2.root",
			      // TString outfilename = "/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/nu_numu_1000_12in_energy_studies_CCQE.root",//"testout2.root",
				   //TString outfilename = "/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/nu_numu_1000_12in_energy_studies_recoquant.root",
				   //TString outfilename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/scripts/editing_ene/outputs/nu_numu_iNUM_CCQE_12in_energy_studies_recoquant_tree.root",
				   //TString outfilename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/scripts/editing_ene/outputs/nu_numu_iNUM_CCQE_12in_energy_studies_recoquant_tree_NEWlookupsB.root",
				   TString outfilename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/scripts/editing_ene/outputs/nu_numu_iNUM_CCQE_12in_energy_studies_recoquant_tree_NEWlookupsB_for_training.root",
				   TString lnLfilename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/scripts/likelihood_tables.root",
				   //TString lookupfilename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/scripts/energyLookups.root",
				   TString lookupfilename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/scripts/nicolas/lookups/lookup40/energyLookups_40_new.root",
				   int startEvent=0, int maxEvents=0)

/*void Energy_studies(TString filename = "/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/outputs_sim_files_withPhotonMask/flav_nue/nu_nue_1000_out_12in_new.root",
		  TString genfilename = "/Disk/ds-sopa-group/PPE/titus/ts-WChSandBox/outputs/flav_nue/nu_nue_1000/generatorcardfile.root",
		  TString outfilename = "/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/nu_nue_1000_12in_energy_studies.root",//"testout2.root",
		  TString lnLfilename = "/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/likelihood_tables.root",
		  TString lookupfilename = "/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/energyLookups.root",
		  int startEvent=0, int maxEvents=0)
*/
...
// Load Data
  ...
  TString filename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/scripts/outputs_photonmask_fortraining/nu_numu_iNUM_out_12in_new_fortraining.root";
  TString genfilename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChSandBox/outputs/flav_numu_fortrain/nu_numu_iNUM/generatorcardfile.root";
    /*TString filename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChRecoSandBox/scripts/nicolas/muCov/mask40/output_photon_mask/nu_numu_iNUM_out_12in_mask.root";
  TString genfilename = "/exports/csce/datastore/ph/groups/PPE/titus/ts-WChSandBox/outputs/flav_numu/nu_numu_iNUM/generatorcardfile.root";
    */
  /*TString filename = "/Disk/ds-sopa-group/PPE/titus/ts-WChRecoSandBox/scripts/nicolas/muCov/mask40/output_photon_mask/nu_numu_1000_out_12in_mask.root";
    TString genfilename = "/Disk/ds-sopa-group/PPE/titus/ts-WChSandBox/outputs/flav_numu/nu_numu_1000/generatorcardfile.root"; */
